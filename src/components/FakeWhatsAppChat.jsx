...
export default function FakeWhatsAppChat() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-4">
      ...
      {/* WhatsApp Header */}
      <div className="flex items-center gap-3 mb-2 p-2 bg-green-600 text-white rounded-t-lg">
        {profilePic ? (
      ...
      <div id="chat-area" className="bg-green-50 rounded-b-lg p-4 space-y-2 min-h-[200px] flex flex-col">
      ...
      <div className="flex justify-center gap-4 mt-4">
        <Button variant={sender === "user" ? "default" : "outline"} onClick={() => setSender("user")}>You</Button>
        <Button variant={sender === "bot" ? "default" : "outline"} onClick={() => setSender("bot")}>Receiver</Button>
      </div>
